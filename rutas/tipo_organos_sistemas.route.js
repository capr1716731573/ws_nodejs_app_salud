...
//DATOS DE LA TABLA
var datos_tabla = {
    tabla_target: 'tipo_organo_sistemas',
    pk_tabla: 'pk_tiporg',
    sp_crud_tabla: 'sp_salud_crud_tipo_organo_sistemas'
}
...
app.get('/busqueda', mdAuthenticationJWT.verificarToken, (req, res, next) => {
    ...
    var consulta;
    //valido que exista el parametro "desde"
    consulta = `SELECT * FROM ${ datos_tabla.tabla_target } WHERE nombre_tiporg LIKE '%${busqueda}%'`;
